  ...
  <div class="panel panel-default">
    ...
    <div class="table-responsive">
      <table class="table table-striped b-t b-light">
		...
		?>
          <tr> 
            <td><?php echo $row['idLSP']; ?></td>
            <td><?php echo $row['tenLSP']; ?></td>
            <td>
              <a href="sua_danh_muc_san_pham.php?malsp=<?php echo $row['idLSP']; ?>" class="active ">
                <i class="fa fa-pencil text-success text-active"></i></a>
              </a>
              <a onclick="return confirm('Bạn có muốn xóa không???')" href="xoa_danh_muc.php?idLSP=<?php echo $row['idLSP']; ?>" class="active ">
