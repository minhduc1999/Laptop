...
<form action="index.php?content=cart&action=insert" method="POST" id="a" onsubmit="return kiemtra();">
	<table>
		...
		?>
		<tr><td colspan="2" align="center" style=""><h4>Thông tin khách hàng</h4></td></tr>
		...
		<tr><td class="tieude">Số điện thoại</td><td><input type="text" name="dienthoai" value="<?php echo $row['dienthoai'] ?>"/></td></tr>
		<tr><td class="tieude">Email</td><td><input type="text" name="email" value="<?php echo $row['email'] ?>"/></td></tr>
		
		<tr><td colspan="2" align="center" style=""><h4>Phương thức thanh toán</h4></td></tr>
		<tr><td class="tieude">Phương thức: </td><td>
			<select name="phuongthuc" required="required">
