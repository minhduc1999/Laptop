...
if(isset($_GET['nsx'])){
	...
	$sql_select_detail_product = "select * from tbl_nhasanxuat  where idNSX = '$nsx'";
                        ...
                        <div class="row">
                            <div class="span12">
                                <h4 class="title">
                                    ...
                                    <span class="pull-left"><span class="text"><span class="line"><a href="product_detail.html"><strong>CÁC SẢN PHẨM <?php echo $row[1]; ?></strong></a></span></span>
                                    </span>
                                ...
                                <div id="myCarousel-2" class="myCarousel carousel slide">
                                    <div class="carousel-inner">                                
                                        <div class="active item">
                                            <ul class="thumbnails">      
                                               <?php 
												$sql_select_laptop_vp = "select * from tbl_sanpham where idNSX = '$nsx'";
