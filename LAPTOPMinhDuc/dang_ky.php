      ...
      <section class="main-content">        
        <div class="row">
          <div class="span12" style="text-align: center;">          
            <h4 class="title"><span class="text" style="font-size: 22px"><strong>Đăng</strong> ký tài khoản</span></h4>
            <form form action="" method="POST" style="text-align: left;">
              <fieldset>
              	<div class="control-group">
                  <label class="control-label" style="font-size:16px; color:blue; " ><b>Tên đăng nhập:</b></label>   
                  <div class="controls">
                  <input type="text" placeholder="Nhập username..." class="input-xlarge" name="taiKhoan" required>
              	   </div>
              	</div>
              	<div class="control-group">
                  <label class="control-label" style="font-size:16px; color:blue; " ><b>Họ và tên:</b></label>   
                  <div class="controls">
                  <input type="text" placeholder="Nhập họ và tên..." class="input-xlarge" name="hoTen" required>
              	   </div>
              	</div>
              	<div class="control-group">
                  <label class="control-label" style="font-size:16px; color:blue; " ><b>Số điện thoại:</b></label>   
                  <div class="controls">
                  <input type="text" placeholder="Nhập số điện thoại..." class="input-xlarge" name="dienThoai" required>
              	   </div>
              	</div>
              	<div class="control-group">
                  <label class="control-label" style="font-size:16px; color:blue; " ><b>Địa chỉ:</b></label>   
                  <div class="controls">
                  <input type="text" placeholder="Nhập địa chỉ..." class="input-xlarge" name="diaChi" required>
              	   </div>
              	</div>
              	<div class="control-group">
                  <label class="control-label" style="font-size:16px; color:blue; " ><b>Email:</b></label>   
                  <div class="controls">
                  <input type="text" placeholder="Nhập gamil..." class="input-xlarge" name="email" required>
              	   </div>
              	</div>
                <div class="control-group">
                  <label class="control-label" style="font-size:16px; color:blue; " ><b>Mật khẩu:</b></label>
                  <div class="controls">
                ...
                <div class="control-group">
                  <label class="control-label" style="font-size:16px; color:blue; " ><b>Nhập lại mật khẩu:</b></label>
                  <div class="controls">
